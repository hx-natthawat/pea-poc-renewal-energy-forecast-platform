...
- [x] Upgrade Python packages to latest versions (Dec 2025: Ruff for linting, pyproject.toml configs)
- [x] Add E2E tests with Playwright (Dec 2025: 28 tests × 5 browsers = 140 total)
- [x] Improve test coverage to 80%+ (Dec 2025: 80% coverage, 486 tests passing)
- [x] Add API versioning (v2 preparation) (Dec 2025: v2 router with health, version endpoints, migration guide)
- [x] Database query optimization (added indexes, voltage caching)
- [x] Frontend bundle size reduction (dynamic imports, code splitting)
